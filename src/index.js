...
const showOptions = () => {console.log('Here are your options:\n1 - play a guessing game\n2 - words of wisdom\n3 - cheer you on!\nAny other key - exit\n');};
...
const chooseOption = () => {
  ...
  if (option === 1) console.log(handleGuessingGame());
  if (option === 2) console.log(getWordsOfWisdom());
  if (option === 3) console.log(getCheer());
}
